...
const NewsFeed: React.FC = () => {
  ...
  const { trackInteraction } = usePerformance('NewsFeed');
    ...
    const observer = new IntersectionObserver(
      (entries) => {
        ...
        if (target.isIntersecting && hasNextPage && !isFetchingNextPage && !isLoadingMore) {
          const endInteraction = trackInteraction('infinite-scroll');
  ...
  }, [hasNextPage, isFetchingNextPage, isLoadingMore, fetchNextPage, trackInteraction]);
